...
def parse_dashboard():
    ...
    summary = {
        ...
        'closingMtd': msr_closing_summary.get('mtd', 0),
        'closingLw': msr_closing_summary.get('lw', 0),
        'closingLm': msr_closing_summary.get('lm', 0),
        'closingLy': msr_closing_summary.get('ly', 0),
